...
void pps_calculate_time(Process *p, int len)    // Recebe como parametro o ponteiro de processos e a quantidade de processo
{
    int i;
    ...
    // Tempo total de execução de processos na CPU
    int total_burst_time = 0;

    int k = 0;

    // Ponteiro que armazena o tempo restante de execução de cada processo
...
void PPS(Process *p, int len)
{
    ...
    // Chama a função que executa o PPS
